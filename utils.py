...
class ObjectDetectionTool(BaseTool):
    name = "Object detector"
    description = (
        "Identifies objects in an image, returning their bounding boxes, class names, and confidence scores."
    )
    ...
    def _run(self, img_path):
        ...
        for score, label, box in zip(results["scores"], results["labels"], results["boxes"]):
            ...
            detections.append(f"Bounding Box: {box_coords}, Class: {class_name}, Confidence: {confidence}")
